...
export default new Vuex.Store({
    ...
    mutations: {
        ...
        updateMessageMutation(state, message) {
            ...
            state.messages = [...state.messages.slice(0, updateIndex),
                message,
        ...
        removeMessageMutation(state, message) {
            ...
            if(deleteIndex > -1)
            {
                state.messages = [...state.messages.slice(0,deleteIndex),
        ...
        addCommentMutation(state, comment) {
            ...
            if(message.comments == null || !message.comments.find(it => it.id === comment.id)) {
                state.messages = [
